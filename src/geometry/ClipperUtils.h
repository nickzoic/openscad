...
ClipperLib::Paths fromPolygon2d(const Polygon2d& poly, int pow2, bool removeHoles=false);
...
Polygon2d *toPolygon2d(const ClipperLib::PolyTree& poly, int pow2, bool removeHoles=false);
ClipperLib::Paths process(const ClipperLib::Paths& polygons,
                          ClipperLib::ClipType, ClipperLib::PolyFillType);
Polygon2d *applyOffset(const Polygon2d& poly, double offset, ClipperLib::JoinType joinType, double miter_limit, double arc_tolerance, bool removeHoles=false);
